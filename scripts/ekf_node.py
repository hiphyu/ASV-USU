...
class PureEKFNode(Node):
    ...
    def __init__(self):
        ...
        # Parameter Q
        self.Q = np.diag([1e-3, 1e-3, 1e-3, 1e-3, 5e-7, 5e-7]) #Lintasan A
        # self.Q = np.diag([0.0005, 0.0005, 0.001, 0.001, 5e-07, 5e-07])
        # self.Q = np.diag([1e-3, 1e-3, 1e-3, 1e-3, 1e-7, 1e-7]) #Lintasan B
